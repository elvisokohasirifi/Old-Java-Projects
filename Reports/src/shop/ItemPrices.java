 ...
 * @author sirel
 */
public class ItemPrices extends javax.swing.JDialog {

    /**
     * Creates new form ItemPrices
     */
    public ItemPrices(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void jButton1MouseClicked(java.awt.event.MouseEvent evt) {                                      
        Shop.setPrice((String) jComboBox1.getSelectedItem(), Double.parseDouble(qty.getText()));
    }                                     
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ItemPrices.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
